...
class Chapter2 extends React.Component {
    render() {
        return (
            <Study label='개별적 근로관계법' data={ChapterTwo} navigation={this.props.navigation}/>
          );
    }
}
class Chapter3 extends React.Component {
    render() {
        return (
            <Study label='비정규 근로자에 관한 특별법' data={ChapterThree} navigation={this.props.navigation}/>
          );
    }
}
class Chapter4 extends React.Component {
    render() {
        return (
            <Study label='집단적 노사관계법' data={ChapterFour} navigation={this.props.navigation}/>
          );
    }
}
